...
export const blogUiCopy = {
  es: {
    ...
    pcRecommendation: 'Recomendado ver en PC para abrir y revisar el ZIP con comodidad.',
    backToBlog: 'Volver al blog',
    downloadHint: 'ZIP con pruebas reales descargadas de fuentes publicas verificables. Recomendado ver en PC. Pago unico de {price}.',
  ...
  en: {
    ...
    pcRecommendation: 'Best viewed on PC so you can open and review the ZIP comfortably.',
    backToBlog: 'Back to blog',
    downloadHint: 'ZIP with real evidence downloaded from verifiable public sources. Best viewed on PC. One-time payment of {price}.',
